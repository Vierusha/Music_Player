...
import com.codex.musicplayer.player.PlayerListener;
...
public class PlayerDialog extends BottomSheetDialog implements SeekBar.OnSeekBarChangeListener, PlayerListener, View.OnClickListener {
    ...
    private void setUpUi() {
        ...
        int icon = playerManager.isPlaying() ? R.drawable.pause : R.drawable.play;
        ...
        int repeat = playerQueue.isRepeat() ? R.drawable.repeat_once : R.drawable.repeat;
    ...
    public void onStateChanged(int state) {
        if (state == State.PLAYING)
            playPauseControl.setImageResource(R.drawable.pause);
        else
            playPauseControl.setImageResource(R.drawable.play);
    }
